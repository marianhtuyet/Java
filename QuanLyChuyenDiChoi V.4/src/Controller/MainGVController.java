 ...
 * @author MyPC
 */
public class MainGVController implements Initializable {

    @FXML
    private JFXButton btnCTyDuLich;
    @FXML
    private JFXButton btnDiaDiem;
    public static MainGVController mainController;
    UserDAO userDAO;
    @FXML
    ...
    public MainGVController() {
        mainController = this;
    }

    public static MainGVController getMainController() {
